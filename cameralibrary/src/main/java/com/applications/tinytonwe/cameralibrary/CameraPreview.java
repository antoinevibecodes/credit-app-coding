...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraPreview(Context context, Camera myCamera){
        ...
        supportedPreviewSizes = this.myCamera.getParameters().getSupportedPreviewSizes();
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height){
        ...
        try {
            ...
            int numberOfImageSizes = supportedPictureSizes.size();

            optimalPictureSize = supportedPictureSizes.get(numberOfImageSizes/2);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (supportedPreviewSizes != null) {
            optimalPreviewSize = getOptimalPreviewSize(supportedPreviewSizes, width, height);
        }
    }
