 ...
 */
public class SingletonCameraData {

    private static SingletonCameraData singletonCameraDataInstance = null;
    ...
    private boolean currentCameraSet = false;

    private PictureTaken pictureTaken;
    private Bitmap originalBitmap;
    private Bitmap croppedBitmap;

    private SingletonCameraData(){
     ...
     */
    public static SingletonCameraData getUniqueInstance(){
        if(singletonCameraDataInstance == null){
            singletonCameraDataInstance = new SingletonCameraData();
        }
        return singletonCameraDataInstance;
    }
    ...
    */
     ...
     */
    public void reset(){
        this.singletonCameraDataInstance = null;
    }

    public void setCurrentCamera(CurrentCamera currentCamera){
        this.currentCamera = currentCamera;
        currentCameraSet = true;
    }

    public CurrentCamera getCurrentCamera(){
        return this.currentCamera;
    }

    public void setPictureTaken(PictureTaken pictureTaken){
        this.pictureTaken = pictureTaken;
    }

    public PictureTaken getPictureTaken(){
